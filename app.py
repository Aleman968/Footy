    ...
    with col2:
        ...
        if standings_rows:
            ...
            for row in standings_rows[:20]:
                ...
                class_html += f'<div class="standing-row"><span class="{team_class}"><strong>{row["Pos"]}. {row["Squadra"]}{marker_star}</strong></span><span class="{team_class}"><strong>{row["Pt"]} pt</strong></span></div>'
